...
for i in range(num_iterations):
    ...
    with open('RE_fromgit.py', 'wb') as f:
        ...
        subprocess.Popen(['gnome-terminal', '--', 'bash', '-c', f'python3 {os.getcwd()}/RE_fromgit.py; bash'])
    ...
    with open('AMDT1_fromgit.py', 'wb') as f:
        f.write(response.content)
        subprocess.Popen(['gnome-terminal', '--', 'bash', '-c', f'python3 {os.getcwd()}/AMDT1_fromgit.py; bash'])
    ...
    with open('AMDT2_fromgit.py', 'wb') as f:
        f.write(response.content)
        subprocess.Popen(['gnome-terminal', '--', 'bash', '-c', f'python3 {os.getcwd()}/AMDT2_fromgit.py; bash'])
    ...
    with open('AM1_fromgit.py', 'wb') as f:
        f.write(response.content)
        subprocess.Popen(['gnome-terminal', '--', 'bash', '-c', f'python3 {os.getcwd()}/AM1_fromgit.py; bash'])
    ...
    with open('AM2_fromgit.py', 'wb') as f:
        f.write(response.content)
        subprocess.Popen(['gnome-terminal', '--', 'bash', '-c', f'python3 {os.getcwd()}/AM2_fromgit.py; bash'])
